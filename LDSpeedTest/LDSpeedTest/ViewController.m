...
- (void)viewDidLoad {
    ...
    [[LDNetworkSpeedTool sharedInstance] startWithURL:[NSURL URLWithString:@"https://qhcs-qjj-stg.credoo.com.cn:33443/qjj_app/website/anychatq/img/bg.png"] speedblock:^(float speed) {
